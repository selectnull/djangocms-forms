...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='formdefinition',
            name='form_template',
            field=models.CharField(blank=True, choices=[('djangocms_forms/form_template/default.html', 'Default')], default='djangocms_forms/form_template/default.html', max_length=150, verbose_name='Form Template'),
        ),
        migrations.AlterField(
